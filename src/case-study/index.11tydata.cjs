module.exports = {
  ...
  heroConfig: {
    ...
    description:
      "<p>Follow a realistic CDC implementation journey: from slow batch ETL to real-time analytics. Learn how decision points, trade-offs, and practical challenges shape production deployments.</p>",
    align: "center",
