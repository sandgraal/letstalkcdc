...
module.exports = {
  ...
  heroConfig: {
    ...
    description: '<p>Build a fully managed CDC pipeline using Fivetran. Connect source databases to cloud warehouses with minimal configuration and zero infrastructure management.</p>',
    align: 'center',
    actions: [
