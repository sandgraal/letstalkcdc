...
module.exports = {
  ...
  heroConfig: {
    ...
    description: '<p>Build a visual CDC pipeline using Matillion ETL with its low-code interface. Includes configuration walkthrough and UI-based workflow setup.</p>',
    align: 'center',
    actions: [
