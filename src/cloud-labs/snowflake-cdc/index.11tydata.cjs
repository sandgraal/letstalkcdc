...
module.exports = {
  ...
  heroConfig: {
    ...
    description: '<p>Implement CDC pipelines using Snowflake with Kafka Connect and Snowpipe for real-time data ingestion. Includes connector configuration and streaming setup.</p>',
    align: 'center',
    actions: [
