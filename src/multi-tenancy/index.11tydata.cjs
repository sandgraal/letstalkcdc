module.exports = {
  ...
  heroConfig: {
    ...
    description:
      "<p>Model isolation levels, topic strategies, and egress math for shared CDC platforms. See how per-tenant choices affect blast radius, spend, and operations.</p>",
    align: "center",
    skillLevel: "Advanced",
    actions: [
      ...
      {
        href: "#mt-controls",
        label: "Tweak Isolation Controls",
        variant: "ghost",
      },
    ],
  },
