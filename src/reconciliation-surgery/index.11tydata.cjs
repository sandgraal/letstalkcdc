module.exports = {
  ...
  heroConfig: {
    ...
    align: 'center',
    actions: [
      { href: '#when-reconciliation', label: 'When to Reconcile', variant: 'primary' },
      { href: '#offset-surgery', label: 'Offset Surgery Guide', variant: 'secondary' }
    ]
  },
  quizConfig: {
    id: "reconciliation-surgery-quiz",
    title: "Reconciliation & Offset Surgery Knowledge Check",
    description: "Test your understanding of data reconciliation and safe offset management.",
    questions: [
      {
        ...
        correct: "2",
        explanation: "Reconciliation is the process of comparing the source database with downstream sinks to identify and fix data discrepancies—missing records, incorrect values, or out-of-order updates. It's a safety net that catches issues missed by the CDC pipeline due to failures, bugs, or operational errors."
      },
      {
        question: "Why might you need to perform 'offset surgery' in a CDC pipeline?",
        options: [
      ...
      },
      {
        ...
        correct: "1",
        explanation: "A SQL diff pattern compares datasets between source and sink using queries (e.g., EXCEPT, MINUS, or hash-based comparisons). This identifies rows that exist in one system but not the other, or rows with mismatched values. It's commonly used in audit loops to detect and repair CDC-related data drift."
      },
      {
