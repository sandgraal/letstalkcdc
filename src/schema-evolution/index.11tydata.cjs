module.exports = {
  ...
  heroConfig: {
    ...
    description:
      "<p>Keep downstream systems humming as source schemas change. Learn how schema registries, compatibility modes, and message contracts safeguard your pipelines from drift.</p>",
    align: "center",
    skillLevel: "Advanced",
    actions: [
      ...
      {
        href: "#compatibility",
        label: "Choose Compatibility Modes",
        variant: "ghost",
      },
    ],
  },
    ...
    questions: [
      {
        ...
        correct: "2",
        explanation:
          "A schema registry acts as a central catalog for event schemas. Producers register schemas, consumers retrieve them, and the registry enforces compatibility rules during schema evolution. This prevents breaking changes from reaching consumers and provides a version history for troubleshooting and rollbacks.",
      },
      {
        question:
        ...
        correct: "2",
        explanation:
          "Backward compatibility means old consumers (using the previous schema version) can successfully read data produced with the new schema. This typically allows adding optional fields or removing fields (as long as consumers handle missing fields). It's essential for zero-downtime deployments where consumers lag behind producers.",
      },
      {
        ...
        correct: "1",
        explanation:
          "Forward compatibility means new consumers (using the updated schema) can read data produced with older schema versions. This allows producers to update at their own pace, knowing newer consumers will handle legacy data gracefully. It's useful when producers can't all be updated simultaneously.",
      },
      {
        question:
        ...
        correct: "2",
        explanation:
          "Removing a required field breaks backward compatibility because old consumers expect that field to exist. If it's missing, they may fail or corrupt data. Safe evolution strategies include: making fields optional before removal, providing defaults, or versioning the event type to signal a breaking change.",
      },
      {
        question:
