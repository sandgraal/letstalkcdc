module.exports = {
  ...
  quizConfig: {
    ...
    description: "Test your understanding of real-world CDC applications and patterns.",
    questions: [
      {
        question: "How does CDC enable real-time analytics and business intelligence?",
        options: [
        ...
        correct: "2",
        explanation: "CDC streams database changes to data warehouses or lakes as they happen, replacing slow nightly batch jobs. This enables real-time dashboards, up-to-the-minute reports, and timely business decisions. Analysts get fresh data without waiting hours for batch ETL to complete."
      },
      {
        ...
        correct: "2",
        explanation: "CDC events signal when specific records change in the source database. Applications can listen to these events and selectively invalidate or update corresponding cache entries (Redis, Memcached, etc.), ensuring the cache stays consistent with the database without relying on TTLs or full cache flushes."
      },
      {
      ...
      },
      {
        ...
        correct: "2",
        explanation: "CDC is a foundational pattern for event-driven architectures. It captures database changes—often the source of truth—and publishes them as events. Downstream systems react to these events, triggering workflows, notifications, or updates. This decouples producers from consumers and enables scalable, asynchronous processing."
      },
      {
