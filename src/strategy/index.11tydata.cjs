module.exports = {
  ...
  heroConfig: {
    ...
    actions: [
      ...
      { href: '#mindset-shift', label: 'Explore the Mindset Shift', variant: 'ghost' }
    ]
  },
  quizConfig: {
    id: "strategy-quiz",
    title: "CDC Strategy Knowledge Check",
    description: "Test your understanding of CDC's strategic value and organizational impact.",
    questions: [
      {
        question: "What is a key business benefit of adopting CDC over traditional batch ETL?",
        options: [
      ...
      {
        question: "What mindset shift does CDC adoption require from data teams?",
        options: [
