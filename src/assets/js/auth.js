...
const PENDING_LOGIN_KEY = 'cdc-pending-login';
...
async function initAppwriteAuth() {
  ...
  if (!endpoint || !project) {
    console.info('Appwrite not configured; authentication unavailable');
    return false;
  }
...
async function login(email, password) {
  ...
  try {
    ...
    window.dispatchEvent(new CustomEvent('cdc:user-logged-in', {
      detail: authState
    }));
...
async function initAuth() {
  ...
  window.dispatchEvent(new CustomEvent('cdc:auth-ready', {
