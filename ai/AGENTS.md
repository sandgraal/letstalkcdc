...
| `site-data`           | Syncs structured data to collections and JSON caches                | On change to `/src/_data/` or manual run          | `ai/scripts/data-sync.mjs`                      | `src/\_data/\*_/_.cjs                                                              | json`, cached data in `ai/\_state/data/`                                                 | Normalized data caches, `ai/logs/site-data.jsonl` | Priya Shah — Data Platform |
