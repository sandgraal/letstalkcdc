...
CONNECTOR_CONFIG="${1:-sandbox/connectors/postgres-connector.json}"
...
echo "Registering Postgres connector from ${CONNECTOR_CONFIG}..."
curl -i -X POST \
...
echo "  curl ${CONNECT_URL}/connectors/postgres-inventory-connector/status"
